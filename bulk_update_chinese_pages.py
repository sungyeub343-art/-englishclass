...
DETAIL_TEMPLATE = """<section class="detail">
  <div class="wrap detail-grid">
    <article class="detail-box">
      <div class="tag-list">
        <span>{prefix} 중국어회화</span>
        <span>직장인 중국어회화</span>
        <span>왕초보 중국어회화</span>
        <span>1:1 화상 중국어회화</span>
      </div>
      <h2>{prefix} 중국어회화, 1:1 화상 중국어회화로 목적별 맞춤 수업을 안내합니다</h2>
      <p>{prefix} 중국어회화 수업을 찾는 학습자들은 중국어 말하기, 중국어 스피킹, 여행회화, 실무 중국어회화처럼 목표가 분명한 경우가 많습니다. 파워잉글리쉬는 {prefix} 중국어회화 상담 단계에서 현재 회화 실력과 학습 목적을 먼저 확인하고, 1:1 화상 중국어회화 방식으로 발화량과 복습 효율을 함께 높일 수 있는 수업 구성을 안내합니다.</p>
      <p>특히 {prefix} 중국어회화는 왕초보 중국어회화부터 직장인 중국어회화, 중국어 발음 교정, HSK 회화 대비까지 수요가 넓게 나뉘기 때문에 같은 커리큘럼으로 접근하면 효율이 떨어질 수 있습니다. 무료 레벨테스트 후 발음, 문장 구성, 응답 속도, 자주 막히는 표현을 점검한 뒤 일상 중국어회화, 여행 중국어회화, 실전 대화, 시험 대비 중국어회화 중 어떤 영역을 우선 강화할지 정하는 방식이 더 효과적입니다.</p>

      <h3>일상회화와 왕초보 중국어회화 중심 수업</h3>
      <p>{prefix} 중국어회화 수업 중에서도 왕초보 중국어회화는 자기소개, 일상 질문, 취미, 일정, 감정 표현처럼 반복 사용 빈도가 높은 주제로 시작하는 것이 좋습니다. 왕초보 중국어회화 단계에서는 어려운 문법 설명보다 짧은 문장을 직접 말해보는 훈련이 중요하며, 화상 중국어회화 수업에서는 발화량을 늘려 실제 중국어회화 적응 속도를 높일 수 있습니다.</p>

      <h3>여행회화와 실전 중국어 스피킹 훈련</h3>
      <p>여행회화가 목표인 경우 {prefix} 중국어회화 수업에서도 공항, 호텔, 식당, 쇼핑, 길 안내, 돌발 상황 대응처럼 실전 장면을 기준으로 연습하는 편이 효율적입니다. 여행 중국어회화는 단어 암기보다 질문 패턴과 응답 패턴을 익히는 것이 중요해서, 1:1 화상 중국어회화 방식으로 상황별 회화 흐름을 반복하면 실제 여행에서 바로 쓰기 쉬운 중국어 말하기 표현을 빠르게 정리할 수 있습니다.</p>

      <h3>비즈니스 중국어회화와 HSK 회화 대비</h3>
      <p>시험 대비 중국어회화는 HSK 회화, 중국어 면접, 발표 준비처럼 답변 구조와 말하기 속도가 중요한 평가에 맞춰 준비해야 합니다. 반면 직장인 중국어회화와 실무 대화는 회의, 보고, 전화 응대, 자기소개, 비즈니스 미팅처럼 실제 업무에 자주 나오는 표현을 중심으로 구성하는 것이 좋습니다. {prefix} 중국어회화 상담에서는 이 두 방향을 구분해 시험 점수 향상이 목표인지, 실무 중국어회화 활용이 목표인지에 따라 맞춤 수업을 제안할 수 있습니다.</p>
    </article>
    <aside class="detail-box">
      <h2>{prefix} 중국어회화 상담 전 참고사항</h2>
      <ul>
        <li>{prefix} 중국어회화 상담 시에는 일상회화, 여행회화, 시험 대비 중국어회화, 직장인 중국어회화 중 우선순위를 먼저 정하는 것이 중요합니다.</li>
        <li>왕초보 중국어회화는 기초 문장 반복, 발화량 확보, 스피킹 자신감 형성이 핵심이라서 수업 난이도 조절이 특히 중요합니다.</li>
        <li>직장인 중국어회화는 저녁 시간대, 주말 수업, 과제 분량, 복습 방식까지 함께 정해야 실제 수업 지속률이 높아집니다.</li>
        <li>시험 대비 중국어회화는 HSK 회화, 중국어 면접, 발표 준비처럼 목표 상황을 구체적으로 정할수록 준비 방향이 명확해집니다.</li>
        <li>1:1 화상 중국어회화는 이동 시간 없이 꾸준히 참여하기 쉬워 {prefix} 직장인, 초보 학습자, 일정이 불규칙한 수강생에게 적합합니다.</li>
      </ul>
    </aside>
  </div>
</section>
...
TITLE_RE = re.compile(r'<title>(?P<prefix>.+?) 중국어회화 1:1 화상회화 무료상담 \| 파워잉글리쉬</title>')
...
def build_faq_section(prefix: str, path: Path) -> str:
    stem = path.stem
    parts = stem.split("-")
    parent_name = f"chinese-{parts[1]}.html" if len(parts) > 1 else "chinese.html"
    parent_label = prefix.replace(" ", "")
    return '<section class="detail faq-section" style="padding-top:8px">\n' \
        '  <div class="wrap">\n' \
        f'    <h2 style="margin:0 0 14px;font-size:24px;">{prefix} 중국어회화 자주 묻는 질문</h2>\n' \
        ...
        f'        <p style="margin:0;color:var(--muted);line-height:1.7">네. 왕초보부터 직장인까지 수준별로 발화량과 복습량을 조절해 {prefix} 중국어회화 수업을 맞춤 설계합니다.</p>\n' \
        '      </article>\n' \
        '      <article style="background:#fff;border:1px solid var(--line);border-radius:14px;padding:18px">\n' \
        ...
        f'        <p style="margin:0;color:var(--muted);line-height:1.7">무료 레벨테스트를 받으면 현재 수준과 목표를 바탕으로 {prefix} 중국어회화 수업 방향을 더 정확히 설정할 수 있습니다.</p>\n' \
        '      </article>\n' \
        '    </div>\n' \
        '  </div>\n' \
        '</section>\n' \
            ...
            "mainEntity": [
                {
                    ...
                    "acceptedAnswer": {"@type": "Answer", "text": f"네. 왕초보부터 직장인까지 수준별로 발화량과 복습량을 조절해 {prefix} 중국어회화 수업을 맞춤 설계합니다."},
                },
                {
                    "@type": "Question",
                    "name": "여행회화와 실무회화 중 무엇을 먼저 준비해야 하나요?",
                    "acceptedAnswer": {"@type": "Answer", "text": "목표에 따라 다르지만, 여행회화는 상황별 패턴 훈련, 실무회화는 업무 표현과 말하기 속도 조절이 핵심입니다."},
                },
            ],
        },
    }
...
def update_file(path: Path) -> bool:
    ...
    text = TITLE_RE.sub(
        rf'<title>{prefix} 중국어회화 1:1 화상 스피킹 수업 | 무료 레벨테스트 | 파워잉글리쉬</title>',
        text,
        count=1,
    )
    ...
    text = OG_TITLE_RE.sub(
        rf'<meta property="og:title" content="{prefix} 중국어회화 1:1 화상 스피킹 수업">',
        text,
        count=1,
    )
    text = OG_DESCRIPTION_RE.sub(
        rf'<meta property="og:description" content="{prefix} 지역 학습자에게 맞춘 중국어회화, 발음 교정, 여행회화, 무료 레벨테스트 상담 페이지입니다.">',
        text,
        count=1,
    )
    text = CSS_RE.sub(r'.card p{margin:0;color:var(--muted);font-size:14.5px;line-height:1.65}\n' + DETAIL_CSS.rstrip(), text, count=1)
    ...
    text = text.replace('<img src="[복사본] 파워잉글리시.jpg"', f'<img src="[복사본] 파워잉글리시.jpg" alt="{prefix} 중국어회화 수업 안내 이미지"', 1)
    if 'application/ld+json' not in text:
        text = text.replace('</head>', build_structured_data(path, prefix, description) + '\n</head>', 1)
    text = CTA_RE.sub(
        rf'<section class="cta">\n  <div class="wrap">\n    <div class="cta-box">\n      <p>{prefix} 중국어회화 상담은 무료 레벨테스트 신청으로 바로 시작할 수 있습니다. 중국어 스피킹, 발음 교정, 여행회화, 성인 맞춤 수업까지 목적에 맞게 안내합니다.</p>',
        text,
        count=1,
    )
...
def main() -> None:
    updated = 0
    skipped = 0
    for path in sorted(ROOT.glob("chinese-*.html")):
        if path.name == "chinese.html":
            continue
        if update_file(path):
            updated += 1
        else:
